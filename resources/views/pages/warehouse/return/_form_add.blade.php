...
{!! csrf_field() ; !!} 
    ...
    <div class="form-group">  
        ...
        <div class="col-sm-5 ">
            {!! Form::select ('search',$so_number, null,['placeholder' => 'Select SO Number...','class'=>'chosen-select','id'=>'search'])!!}
        </div>

        <div class="col-sm-3">
            <button type="button" class="btn btn-primary" id="btn-search">Search Sales Order #</button>
        </div>
     </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
              {!! Form::text('so_date',null, ['class'=>'form-control','readonly'=>true, 'id'=>'lbl_so_date']) !!}
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            {!! Form::text('customer',null, ['class'=>'form-control','readonly'=>true, 'id'=>'lbl_customer']) !!}
        </div>
