{!! Form::open(['route'=>'event.upload_image' ,'enctype'=>"multipart/form-data",  'class'=>'form-horizontal']) !!}   
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Event Photo <span class="text-danger">*</span></label>
                    <div class="col-sm-6">
